...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_weight', default='cpt_zhenhuan', type=str, help="保存权重的前缀名")
    ...
    parser.add_argument("--data_path", type=str, default="/root/autodl-tmp/Minimind/dataset/zhenhuan_pretrain.jsonl", help="预训练数据路径")
