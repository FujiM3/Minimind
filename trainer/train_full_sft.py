...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_weight', default='sft_zhenhuan_final', type=str, help="保存权重的前缀名")
    ...
    parser.add_argument("--data_path", type=str, default="../dataset/zhenhuan_sft_conversations.jsonl", help="训练数据路径")
    parser.add_argument('--from_weight', default='cpt_zhenhuan', type=str, help="基于哪个权重训练，为none则不基于任何权重训练")
